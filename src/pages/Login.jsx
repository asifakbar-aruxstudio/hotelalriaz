    ...
    <div className="min-h-screen bg-[#f8f6f1] flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full bg-white rounded-none shadow-[0_24px_80px_rgba(0,0,0,0.08)] p-10">
        <div className="text-center mb-10">
          <h2 className="text-3xl font-display font-semibold text-[#0a0a0a] mb-2">Welcome Back</h2>
          <p className="text-[#6b6b6b] font-light">Sign in to your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full bg-[#0a0a0a] text-white py-4 font-semibold tracking-[0.12em] uppercase text-xs hover:bg-[#0d9488] hover:text-[#0a0a0a] transition-all duration-300 mt-2"
          >
            Sign In
          </button>
        </form>
        ...
        <p className="text-center mt-8 text-[#6b6b6b] text-sm">
          ...
          <Link to="/register" className="text-[#0d9488] font-semibold hover:underline">
            Register here
          </Link>
        </p>
      </div>
